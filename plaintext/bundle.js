...
/***/ function(module, exports, __webpack_require__) {
	...
	var demo = _interopRequire(__webpack_require__(3));

	var ScrollSpy = _interopRequire(__webpack_require__(4));
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Assoc = React.createClass({
	    ...
	    recheckHighlight: function recheckHighlight() {
	    ...
	    shouldHighlight: function shouldHighlight() {
	        ...
	        try {
	            for (var _iterator = elemsEntered[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ScrollSpy = (function (_React$Component) {
	    function ScrollSpy() {
	        ...
	        _get(Object.getPrototypeOf(ScrollSpy.prototype), "constructor", this).call(this);
	        this.state = {
	            closestH2: null,
	            closestH3: null };
	    }
	    ...
	    _createClass(ScrollSpy, {
	        render: {
	            value: function render() {
	                ...
	                var closestH2 = _state.closestH2;
	                var closestH3 = _state.closestH3;

	                console.log(this.state);
	                var h2s = this.hierarchy.map(function (h2) {
	                    var classes = "";
	                    var h3s = null;

	                    if (closestH2 === h2.id) {
	                        classes = "selected";
	                        h3s = h2.children.map(function (h3) {
	                            // var classes = React.classSet({
	                            //     selected: closestH3 === h3.id,
	                            // });
	                            var classes = closestH3 === h3.id ? "selected" : "";
	        ...
	        onScroll: {
	            value: function onScroll() {
	                ...
	                this.hierarchy.forEach(function (h2) {
	                ...
	                this.setState({ closestH2: closestH2, closestH3: closestH3 });
	            }
	        },
	        componentWillMount: {
